...
| 工具 | 介紹 |
|------|------|
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) | Self-improving AI agent framework with persistent memory, multi-platform support, and extensible skills |
| [Codex CLI](https://github.com/openai/codex) | OpenAI's autonomous coding agent CLI — describe what you want, it codes, tests, and ships |
| [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) | Benchmark and evaluation toolkit for LLMs, supporting MMLU, GSM8K, HumanEval and more |
...
| [Talos Linux](https://github.com/talos-systems/talos) | The first Kubernetes OS that is immutable, declarative, and managed entirely through the Machine Config Operator |
...
| [Dashy](https://github.com/Lissy93/dashy) | Beautiful, feature-rich self-hosted dashboard for your homelab |
...
| [FastAPI](https://github.com/fastapi/fastapi) | Modern, fast (high-performance), web framework for building APIs with Python 3.7+ based on standard Python type hints |
...
| [Snyk Agent Scan](https://github.com/snyk/agent-scan) | Scan AI agent skills and MCP servers for prompt injection, malicious code, secret exposure, and supply chain risks |
...
| [Technitium DNS Server](https://github.com/TechnitiumDNS/Technitium) | Self-hosted ad-blocking DNS server with advanced features |
...
| [Rsync](https://github.com/Rsync/rsync) | Fast, versatile, remote (and local) file-copying tool. Essential for efficient file synchronization and backup |
...
| 工具 | 介紹 |
|------|------|
| [Prometheus](https://github.com/prometheus/prometheus) | Powerful metrics collection and alerting system. The de facto standard for Kubernetes monitoring |
| [Grafana](https://github.com/grafana/grafana) | Beautiful, expressive visual dashboards for Prometheus, InfluxDB, Elasticsearch, and more |
| [Beszel](https://github.com/henrygd/beszel) | Lightweight server monitoring hub with Docker container support, real-time metrics, and alerting |
